...
Page({
  data: {
    ...
    "pageName": "田趣小集",
    needhome: true,
    "nothing_text": "您还没有免单记录",
    "nothing_tips": "不如去送礼试试运气吧",
    // text:"这是一个页面"
  },
  ...
  getData: function(isclear = 0) {
    ...
    url += "/ziyoutechan/customer/getfreeorders?";
      ...
      success: function(data) {
        ...
        if (data.returncode == 0) {
          ...
          var orders = order_list.map(function(order) {
            ...
            order.order_time = util.formatTime(order.time);
  ...
  onShareAppMessage: function () { 
    return getApp().share({ title: "送礼品 赢返现,快来看看吧", desc: "", path: "pages/freeorders/freeorders?useless=0" });
     },
