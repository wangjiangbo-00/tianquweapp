...
Page({
  ...
  getData: function(isclear = 0) {
    ...
    url += "/ziyoutechan/customer/getrecommendpersons?";
  ...
  toGift: function(order_id, index) {
    ...
    var order = this.data.persons[index];
